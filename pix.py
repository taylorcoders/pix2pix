# -*- coding: utf-8 -*-
"""
Created on Fri Jul 31 12:30:04 2020
...
train_input_dir="F:/project/facades/train"       # 训练集输入
train_output_dir="F:/project/facades/ckt"  # 训练集输出
 
test_input_dir="F:/project/facades/val"          # 测试集输入
test_output_dir="F:/project/facades/test_out"    # 测试集的输出
checkpoint="F:/project/facades/ckt"        # 保存结果的目录
